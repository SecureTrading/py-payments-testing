config = {
    ...
    "config_tokenisation_visa": "configTokenizationVisa.json",
    "config_tokenisation_amex": "configTokenizationAmex.json",
    "config_tokenisation_visa_defer_init": "configTokenizationVisaDeferInit.json",
    "config_tokenisation_amex_defer_init": "configTokenizationAmexDeferInit.json",
    "config_tokenisation_bypass_cards_visa": "configTokenizationBypassCardVisa.json",
    "config_tokenisation_visa_request_types": "configTokenizationVisaRequestTypes.json",
