Feature: Visa Checkout
 As a user
  ...
  @base_config @extended_tests__part_2 @wallet_test @visa_test
  ...
  @config_submit_on_success_true @extended_tests__part_2 @visa_test
  ...
  @base_config @extended_tests__part_2 @wallet_test
  ...
  @config_update_jwt_true @smoke_test_part_2 @extended_tests__part_2
