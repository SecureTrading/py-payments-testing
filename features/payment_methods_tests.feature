Feature: Payment methods
  ...
  @base_config @full_test_part_1 @cardinal_commerce
...
#      | DECLINE         | Decline                | red   |
  ...
  @base_config @smoke_test_part_1 @full_test_part_1
...
#      | ERROR      | Invalid response                        | red   |
  ...
  @config_animated_card_true @full_test_part_1 @animated_card
...
#      | 3000000000000111    | 3000 000000 000111     | 12/23          | 123 | DINERS       |
  ...
  @base_config @full_test_part_1 @fields_validation
  ...
  Scenario: Filling 3-number of cvc code for AMEX card
    ...
    #  @full_test_part_1 @fields_validation
...
#    And User will see that notification frame has "red"
  ...
  @base_config @full_test_part_1 @wallet_test @visa_test
...
#      | ERROR       | "Invalid response"          | red    |
  ...
  @base_config @full_test_part_1 @unlock_payment_form
  ...
  @base_config @full_test_part_1 @translations
...
#      | sv_SE    |
  ...
  @config_animated_card_true @animated_card @full_test_part_1 @translations
...
#      | de_DE    |
  ...
  @base_config @full_test_part_2 @translations
...
#      | de_DE    |
  ...
  @base_config @full_test_part_2 @visa_test @translations
...
#      | no_NO    |
  ...
  @config_immediate_payment @smoke_test_part_2 @full_test_part_2
  ...
  @config_immediate_payment @full_test_part_2
...
#      | ERROR      | Invalid response |
  ...
  @config_submit_on_success_and_error_true @smoke_test_part_2 @full_test_part_2
...
#  @config_submit_on_success_and_error_true @smoke_test_part_1 @full_test_part_1 @visa_test
...
#    Then User will see payment status information included in url
  ...
  @config_defer_init_and_start_on_load_true @full_test_part_2
  ...
  @config_submit_cvv_only @smoke_test_part_2 @full_test_part_2
  ...
  @config_incorrect_request_type @full_test_part_2
  ...
  @base_config @parent_iframe @full_test_part_2 @cardinal_commerce
  ...
  @config_animated_card_true @parent_iframe @full_test_part_2 @animated_card
  ...
  @base_config @parent_iframe @full_test_part_2
  ...
  @config_notifications_false @smoke_test_part_2 @full_test_part_2
  ...
  @config_submit_on_success_and_error_true  @full_test_part_2
